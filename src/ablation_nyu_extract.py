...
def build_features(train, labels, 
                   params={"fisher": False, "pearson": True, 
...
params={"fisher": False, "pearson": True, 
        "spearman": False, "difussion": False, 
        "spectral": False, "ddt": False, "win_len":  40, "step": 15}
...
print("y = ", y)
joblib.dump(X, f"data/fc-fisher-mean/X{n_rois}.joblib")
joblib.dump(y, f"data/fc-fisher-mean/y{n_rois}.joblib")
